  ...
  const handleSubmit = (event) => {
    ...
    return (
        ...
        <div className="mb-3">
          ...
          <input name='password' value={signupData.password} placeholder="Enter Password" type="password" className="form-control" id="password" 
          onChange={(event) => {updateSignupData(event)}} />
        ...
        <div className="mb-3">
          ...
          <input name='confirmPassword' value={signupData.confirmPassword} placeholder="Enter Password Again" type="password" className="form-control" id="confirmPassword" 
          onChange={(event) => {updateSignupData(event)}} />
